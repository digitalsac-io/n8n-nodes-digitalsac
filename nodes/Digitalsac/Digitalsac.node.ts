		...
		properties: [
			{
				...
				options: [
					...
					{ name: 'Send WABA Template', value: 'sendWabaTemplate', action: 'Send a whats app business template' },
					...
					{ name: 'Validate WhatsApp', value: 'validateWhatsapp', action: 'Validate a whats app number' },
				],
